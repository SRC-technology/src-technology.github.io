...
var renderLoop = function renderLoop(context2d, squareSide, length, time) {
  context2d.clearRect(0, 0, width * devicePixelRatio, height * devicePixelRatio);
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (_ref2.current !== undefined) {
      ...
      var _middlePoint = [Math.floor(width / 2) * devicePixelRatio, Math.floor(height / 2) * devicePixelRatio];

      var context2d = _ref2.current.getContext('2d');

      var _draw = drawSquare(squareSide)(context2d);

      var length = 30;
      var time = 0;
      setInterval(function () {
        renderLoop(context2d, _draw, length, time);
        time += 1;
      }, 50);
    }
  });
...
//# sourceMappingURL=index.js.94d53a8794d08a9ecbd5.hot-update.js.map